...
#模型训练
history = model.fit(train_X, train_y,validation_data=(test_X, test_y), epochs=200, batch_size=30, verbose=2,shuffle=False)#epochs=100, batch_size=16
#预测
...
waviness_train=waviness_train.reshape(-1,1)
...
waviness_pre = waviness_pre.reshape(-1,1)
waviness_y = test_y[:,0]
